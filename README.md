...
自己対局におけるNPSは
```
[NPS]1989512510[node]/129005131[μs](15421964[nps])

[NPS]74341244[node]/4716954[μs](15760431[nps])
[NPS]74341244[node]/5021209[μs](14805444[nps])
```
実行環境は
```
Architecture:             x86_64
...
- pv_search_lineinfo
    ...
    - def_reach.count_ones() あり、なしでの比較
    - 計測用のボードの設定
- mctsの高速化（暇だったら）
    - 差分更新によるロールアウトの激高速化